...
from PyPIC3D.solvers.first_order_yee import update_E, update_B_internal
...
class TestFieldsMethods(unittest.TestCase):
    ...
    def test_update_B(self):
        ...
        Bx_computed, By_computed, Bz_computed = update_B_internal(E_initial, B_initial, self.world, self.constants, curl_func)
